...
# Реализация окна со стартовыми вопросами
...
# Реализация окна со статистикой
...
# Реализация окна с вводом количества продукта
